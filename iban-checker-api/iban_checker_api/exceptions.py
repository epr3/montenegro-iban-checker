...
async def http_exception_handler(request, exc):
    ...
    return JSONResponse(content=jsonable_encoder({"message": str(exc.detail["message"]), "data": exc.detail["data"], "success": False, "error": error, "status": exc.status_code }), status_code=exc.status_code)
